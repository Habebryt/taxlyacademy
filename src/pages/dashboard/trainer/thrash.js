  ...
  const handleSubmit = async (e) => {
    ...
    if (authStatus !== "success" || !db || !auth.currentUser) {
      setModalContent({
        ...
        message:
          "Could not connect to the database. Please refresh and try again.",
      });
      return;
    }
      ...
      <div className="dashboard-page-content">
        ...
        >
          ...
          {learningOutcomes.map((outcome, index) => (
            <div key={index} className="input-group mb-2">
              ...
              <input
                ...
                value={outcome}
                onChange={(e) =>
                  handleDynamicChange(index, e.target.value, "outcomes")
                }
          ...
          {curriculum.map((week, index) => (
            <div key={index} className="input-group mb-2">
              ...
              <input
                ...
                value={week}
                onChange={(e) =>
                  handleDynamicChange(index, e.target.value, "curriculum")
                }
              ...
              {curriculum.length > 1 && (
                <button
                  type="button"
                  className="btn btn-outline-danger"
                  onClick={() => removeDynamicField(index, "curriculum")}
                >
                  &times;
                </button>
              )}
          ...
          <button
            type="button"
            className="btn btn-sm btn-outline-secondary"
            onClick={() => addDynamicField("curriculum")}
          >
            <PlusCircle className="me-1" />
            Add Week/Module
          </button>
          ...
          <div className="mb-3">
            ...
            <input
              ...
              className="form-control"
              value={courseData.careerOpportunities}
              onChange={handleCourseChange}
