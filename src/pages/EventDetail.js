              ...
              >
                <div className="card-body text-center">
                  <h4 className="card-title">
                    {isPast ? "Event Archive" : "Register Now"}
                  </h4>
                  <p className="text-muted">
                    {isPast
                      ? "This event has concluded. You can view the recording below."
                      : "Secure your spot for this event. It's free!"}
                  </p>
                  <a
                    ...
                    className={`btn btn-lg w-100 ${
                      isPast ? "btn-secondary" : "btn-primary"
                    }`}
                  >
