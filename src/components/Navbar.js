        ...
        <div className="collapse navbar-collapse" id="navbarContent" ref={navbarCollapseRef}>
          <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item dropdown">
              <a className="nav-link dropdown-toggle" href="#" id="partnershipsDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                Partnerships
              </a>
              <ul className="dropdown-menu" aria-labelledby="partnershipsDropdown">
                ...
                <li>
                  <Link className="dropdown-item d-flex align-items-center" to="/for-schools" onClick={handleCloseMenu}>
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="moreDropdown">
                <li>
                  <Link className="dropdown-item" to="/events" onClick={handleCloseMenu}>Events</Link>
                </li>
                <li>
                  <Link className="dropdown-item" to="/blog" onClick={handleCloseMenu}>Blog</Link>
                </li>
                <li><hr className="dropdown-divider" /></li>
                <li>
